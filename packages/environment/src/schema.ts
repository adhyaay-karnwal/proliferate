...
const requiredForProvider = (env: EnvLike, provider: "e2b" | "modal" | "vps") =>
    z
        .string()
        .optional()
...
export const createServerSchema = (env: EnvLike = process.env) => {
    ...
    return {
        ...
        DEFAULT_SANDBOX_PROVIDER: z.enum(["e2b", "modal", "vps"]),
        ...
        VPS_HOST: requiredForProvider(env, "vps"),
        VPS_SSH_KEY: requiredForProvider(env, "vps"),
        VPS_SSH_USER: optionalString, // Defaults to 'root'
        VPS_BASE_IMAGE: optionalString, // Defaults to 'shadow-sandbox:latest'
        VPS_DATA_VOLUME: optionalString, // Defaults to '/var/shadow/sandboxes'
